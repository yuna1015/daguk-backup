...
const products = [
  ...
  { code: "TC 65/35 SP140 2×1", name: "TC 65/35 SP140 2×1", cat: "립", img: "/products/tc-6535-cream.png" },
  { code: "TC 65/35 SP70 2×1", name: "TC 65/35 SP70 2×1", cat: "립", img: "/products/tc-6535-charcoal.png" },
  { code: "TC 65/35 단사 1×1", name: "TC 65/35 단사 1×1", cat: "립", img: "/products/tc-6535-mauve.png" },
  { code: "TC 65/35 이합 1×1", name: "TC 65/35 이합 1×1", cat: "립", img: "/products/tc-6535-olive.png" },
