...
const products: { code: string; name: string; cat: string; img: string; tag?: string; hideCaption?: boolean; specs?: { gauge?: string; inch?: string; needles?: string; qty?: string } }[] = [
  ...
  { code: "C/Mo Slub Varigate", name: "C/Mo Slub Varigate Golji", cat: "골지", img: "/products/cmo-slub-varigate-cream.png"  },
  { code: "DG-G04", name: "포인텔 골지",         cat: "골지", img: "/products/pointelle-cream-v3.png"  },
